...
/**
 * Subtraction difficulty settings that will be displayed in the Gui.
 *
 */
public class SubtractionDifficultyGui {
	...
	public SubtractionDifficultyGui(int uid, int overallSkill,
	...
	public void setNumericalSkillTypesDifficultyGui(
			NumericalSkillTypesDifficultyGui numericalSkillTypesDifficultyGui) {
